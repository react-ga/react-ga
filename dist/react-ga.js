...
var _removeLeadingSlash = __webpack_require__(25);

var _removeLeadingSlash2 = _interopRequireDefault(_removeLeadingSlash);

var _trim = __webpack_require__(13);

var _trim2 = _interopRequireDefault(_trim);

var _loadGA = __webpack_require__(26);
...
var _OutboundLink = __webpack_require__(28);
...
function _gaCommand(trackerNames) {
  ...
  if (typeof _ga === 'function') {
    ...
    _ga.apply(undefined, args);
    if (Array.isArray(trackerNames)) {
      trackerNames.forEach(function (name) {
        _ga.apply(undefined, _toConsumableArray([name + '.' + command].concat(args.slice(1))));
      });
    }
  }
}
...
function _initialize(gaTrackingID, options) {
  ...
  if (options && options.gaOptions) {
    _ga('create', gaTrackingID, options.gaOptions);
  } else {
    _ga('create', gaTrackingID, 'auto');
  }
}

var ReactGA = {
  initialize: function initialize(configs, options) {
    if (typeof window === 'undefined') {
      return false;
    }

    _ga = (0, _loadGA2.default)();
   ...
   * @param {Array} trackerNames - (optional) a list of extra trackers to run the command on
   */
  send: function send(fieldObject, trackerNames) {
   ...
   * @param {Array} trackerNames - (optional) a list of extra trackers to run the command on
   */
  pageview: function pageview(rawPath, trackerNames) {
    if (!rawPath) {
   ...
   * @param {Array} trackerNames - (optional) a list of extra trackers to run the command on
   */
  modalview: function modalview(rawModalName, trackerNames) {
    if (!rawModalName) {
   ...
   * @param {Array} trackerNames - (optional) a list of extra trackers to run the command on
   */
  exception: function exception(_ref3, trackerNames) {
      ...
      if (typeof _ga === 'function') {
        if (typeof pluginName !== 'string') {
          ...
          if (actionType && payload) {
            _ga(command, actionType, payload);
            if (_debug) {
   ...
   */
  outboundLink: function outboundLink(args, hitCallback, trackerNames) {
...
_OutboundLink2.default.trackLink = ReactGA.outboundLink.bind(ReactGA);
ReactGA.OutboundLink = _OutboundLink2.default;

exports.default = ReactGA;
...
var _mightBeEmail = __webpack_require__(23);

var _mightBeEmail2 = _interopRequireDefault(_mightBeEmail);

var _toTitleCase = __webpack_require__(24);
