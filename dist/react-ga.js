...
// CONCATENATED MODULE: ./src/utils/mightBeEmail.js
...
// CONCATENATED MODULE: ./src/utils/trim.js
// GA strings need to have leading/trailing whitespace trimmed, and not all
// browsers have String.prototoype.trim().
function trim(s) {
  return s.replace(/^\s+|\s+$/g, '');
}
// CONCATENATED MODULE: ./src/utils/toTitleCase.js
/**
...
// CONCATENATED MODULE: ./src/utils/console/warn.js
function warn(s) {
...
// CONCATENATED MODULE: ./src/utils/removeLeadingSlash.js
...
// CONCATENATED MODULE: ./src/utils/loadGA.js
...
// CONCATENATED MODULE: ./src/utils/console/log.js
function log(s) {
  console.info('[react-ga]', s);
}
// CONCATENATED MODULE: ./src/utils/testModeAPI.js
var gaCalls = [];
...
// CONCATENATED MODULE: ./src/components/OutboundLink.js
...
_defineProperty(OutboundLink_OutboundLink, "propTypes", {
  eventLabel: external_prop_types_default.a.string.isRequired,
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "event", function() { return src_event; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OutboundLink", function() { return src_OutboundLink; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "testModeAPI", function() { return src_testModeAPI; });
...
var src_internalGa = function internalGa() {
  var _window;
...
function _gaCommand(trackerNames) {
  ...
  if (typeof src_internalGa === 'function') {
    if (typeof command !== 'string') {
      warn('ga command must be a string');
      return;
    }

    if (_alwaysSendToDefaultTracker || !Array.isArray(trackerNames)) src_internalGa.apply(void 0, args);

    if (Array.isArray(trackerNames)) {
      trackerNames.forEach(function (name) {
        src_internalGa.apply(void 0, _toConsumableArray(["".concat(name, ".").concat(command)].concat(args.slice(1))));
      });
    }
  }
}
...
function _initialize(gaTrackingID, options) {
  ...
  if (options && options.gaOptions) {
    src_internalGa('create', gaTrackingID, options.gaOptions);
  } else {
    src_internalGa('create', gaTrackingID, 'auto');
  }
}
...
function ga() {
  ...
  if (args.length > 0) {
    src_internalGa.apply(void 0, args);
...
function set(fieldsObject, trackerNames) {
  ...
  if (src_typeof(fieldsObject) !== 'object') {
...
function pageview(rawPath, trackerNames, title) {
  ...
  if (typeof ga === 'function') {
    _gaCommand(trackerNames, 'send', src_objectSpread({
      hitType: 'pageview',
      page: path
    }, extraFields));
...
function src_event() {
  var _ref2 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      args = src_objectWithoutProperties(_ref2, ["category", "action", "label", "value", "nonInteraction", "transport"]);
...
var src_OutboundLink = OutboundLink_OutboundLink;
var src_testModeAPI = testModeAPI;
